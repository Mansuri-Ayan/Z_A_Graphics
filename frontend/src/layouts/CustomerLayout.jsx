    ...
    <div className="bg-gray-50 min-h-screen pb-16">
      ...
      <div className="bg-white border-b border-gray-100 pt-32 md:pt-40 pb-8 md:pb-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gray-100 rounded-full blur-[80px] transform translate-x-1/4 -translate-y-1/4"></div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10">
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-white border border-gray-200 shadow-sm flex items-center justify-center">
                  <span className="text-2xl md:text-3xl font-black text-brand-black tracking-tighter">JD</span>
                </div>
                {/* VIP / Pro Badge */}
                <div className="absolute -bottom-2 -right-2 bg-brand-black text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full border border-brand-black shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-wrap gap-4 shrink-0">
              ...
              <div className="bg-white border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-4 md:p-5 flex items-center gap-4 md:gap-5 min-w-[180px] md:min-w-[200px] transition-transform hover:-translate-y-1">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center text-brand-black shrink-0">
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] overflow-hidden sticky top-32">
              <nav className="flex flex-col p-3 gap-1">
                {navItems.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.name}
                      to={item.path}
                      className={`px-5 py-4 rounded-2xl text-sm font-bold transition-all flex items-center gap-3 ${isActive
                ...
                <button
                  ...
                  className="px-5 py-4 cursor-pointer rounded-2xl text-sm font-bold text-left text-red-500 hover:bg-red-50 hover:text-red-600 transition-all flex items-center gap-3"
                >
                  Logout
                </button>
              </nav>
