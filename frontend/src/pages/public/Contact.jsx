...
const Contact = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="relative w-full pt-32 pb-40 lg:pt-40 lg:pb-48 flex items-center justify-center overflow-hidden bg-[#050505] rounded-b-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] mb-8">
        ...
        <div className="absolute inset-0">
          ...
          {/* Animated Glows */}
          <div className="absolute top-1/4 left-1/4 w-[30rem] h-[30rem] bg-brand-blue/20 rounded-full mix-blend-screen filter blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-0 right-1/4 w-[25rem] h-[25rem] bg-purple-600/10 rounded-full mix-blend-screen filter blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 tracking-tight text-white drop-shadow-lg">
      ...
      <section className="pb-16 -mt-32 relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12">
          {/* Left: Contact Form */}
          <div className="w-full lg:w-1/2">
            {!submitted ? (
              <div className="bg-white/90 backdrop-blur-2xl rounded-[2.5rem] border border-white/50 p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] relative overflow-hidden">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-2 tracking-tight">Send an Inquiry</h2>
                <p className="text-gray-500 font-medium mb-10">We usually respond within 2-4 hours.</p>
